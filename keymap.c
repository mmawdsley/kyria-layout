 ...
 */
    [_QWERTY] = LAYOUT(
      ...
      KC_LSFT,              KC_Z, KC_X, KC_C,    KC_V,     KC_B,    KC_DEL,     KC_LGUI, KC_RGUI, KC_BSLS,    KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                        KC_MUTE, KC_LCTL,  KC_LALT, MO(_LOWER), KC_ENT,  KC_SPC,  MO(_RAISE), KC_RALT, KC_RCTL,  XXXXXXX
    ),
/*
 * Base Layer: Game
 *
 ...
 */
    [_GAME] = LAYOUT(
      ...
      MT(MOD_LCTL, KC_ESC), KC_A,  KC_S,   KC_D,    KC_F,   KC_G,                                                KC_H,    KC_J,     KC_K,    KC_L,    KC_SCLN, KC_QUOT,
      KC_LSFT,              KC_Z,  KC_X,   KC_C,    KC_V,   KC_B,    KC_DEL,      KC_LGUI, KC_RGUI, KC_BSLS,     KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                           KC_MUTE, KC_DEL, KC_LALT, MO(_LOWER),  KC_SPC,  KC_ENT,  MO(_RAISE),  KC_RALT, KC_RCTL,  XXXXXXX
    ),
/*
 * Lower Layer: Symbols
 *
